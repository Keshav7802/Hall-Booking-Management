...
const boxStyle = {
  backgroundColor: '#87CEEB', // Sky blue background for the box
  padding: '1.5rem',
  ...
  return (
    <div style={{ display: 'flex' }}>
      ...
      <div style={{ ...columnStyle }}>
        ...
        <div style={{ fontSize: '1.5rem', fontWeight: 'bold', color: '#555', marginTop: '1rem' }}>
      ...
      <div style={{ ...columnStyle2 }}>
        <div style={{ ...boxStyle }}>
          ...
          {/* <li>              <a
              ...
              <li>
             Click on Login/SignUp Button to Login in your Account
            </li>
            <li>
        ...
        <Link className="btn btn-dark" to="/login" role="button" style={{marginTop : '4rem', marginLeft : '12.5rem'}}>
